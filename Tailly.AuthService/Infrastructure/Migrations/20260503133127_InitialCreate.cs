    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminPasswordRecoverys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPermanentBlock = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ...
                    SpecialistSlug = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountDeletionTokens", x => x.Token);
                    table.ForeignKey(
                        name: "FK_AccountDeletionTokens_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordAttemptsLockUntil = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountDeletionTokens_UserId",
                table: "AccountDeletionTokens",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AdminPasswordRecoverys_Email",
                table: "AdminPasswordRecoverys",
                column: "Email");
